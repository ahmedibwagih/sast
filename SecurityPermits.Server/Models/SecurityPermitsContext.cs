...
//        => optionsBuilder.UseSqlServer("Data Source=HOITL-22837\\SQLEXPRESS;Initial Catalog=SecurityPermits;User ID=ahmed;Password=123456;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AccessPermit>(entity =>
        {
            ...
            entity.Property(e => e.EmpNumber).HasColumnName("EmpNumber");
        ...
        modelBuilder.Entity<Permit>(entity =>
        {
            ...
            entity.Property(e => e.Status).HasComment("حاله الاعتماد -1 0  1 مرفوض جديد تم الاعتماد   المشرف  2 الاعتماد الرئيسي");
            entity.Property(e => e.SupervisorEmpDate)
                .HasColumnType("datetime")
                .HasColumnName("supervisorEmpDate");
            entity.Property(e => e.SupervisorEmpNumber).HasColumnName("supervisorEmpNumber");
        });
        ...
        {
            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.DeviceReturnStateName)
                .HasMaxLength(50);
        });
