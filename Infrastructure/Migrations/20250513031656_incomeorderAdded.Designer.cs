...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250513031656_incomeorderAdded")]
    partial class incomeorderAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Account.AAccount", b =>
                {
                    ...
                    b.Property<bool?>("HasDirectCostCenter")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Entities.Clients.ExClientSectors", b =>
                {
                    b.Property<int>("ClientSectorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ClientSectorNameAr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ClientSectorNameEn")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entities.LookUps.ClientActivities", b =>
                {
                    b.Property<int>("ClientActivityID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.LookUps.FinYears", b =>
                {
                    b.Property<int>("FinYearId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FinYearId"));
            ...
            modelBuilder.Entity("Core.Entities.LookUps.FinYearsPeriods", b =>
                {
                    b.Property<int>("FinYearsPeriodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FinYearsPeriodId"));
                    ...
                    b.HasKey("FinYearsPeriodId");

                    b.HasIndex("FinYearId");

                    b.ToTable("FinYearsPeriods");
                });

            modelBuilder.Entity("Core.Entities.LookUps.ShiftTracking", b =>
                {
                    b.Property<int>("ShiftTrackingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ShiftTrackingID"));
            ...
            modelBuilder.Entity("Core.Entities.LookUps.TreasuryDealers", b =>
                {
                    b.Property<int>("TreasuryDealerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TreasuryDealerId"));
                    ...
                    b.HasKey("TreasuryDealerId");

                    b.HasIndex("TreasuryId");

                    b.HasIndex("UserId");

                    b.ToTable("TreasuryDealers");
                });

            modelBuilder.Entity("Core.Entities.Sec.ActivationKeys", b =>
                {
                    b.Property<int>("ActivationKeyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ActivationKeyId"));
            ...
            modelBuilder.Entity("Core.Entities.Sec.Setting", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.Sec.UserSetting", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.TRN_Invoices.ExInvoice", b =>
                {
                    ...
                    b.Property<decimal?>("PaidCheck")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("PaidCheckNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal?>("PaidUnderAccount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Core.Entities.others.AJvAccountSetting", b =>
                {
                    ...
                    b.Property<int>("Income_St_order")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Clients.ExClient", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Clients.ExClientSectors", "ExClientSectors")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.LookUps.CurrencyBase", b =>
                {
                    b.HasOne("Core.Entities.LookUps.ExCountry", "ExCountry")
                        .WithMany()
                        .HasForeignKey("CountryId");

                    b.Navigation("ExCountry");
                });
            ...
            modelBuilder.Entity("Core.Entities.LookUps.FinYearsPeriods", b =>
                {
                    b.HasOne("Core.Entities.LookUps.FinYears", "FinYears")
                        .WithMany()
                        .HasForeignKey("FinYearId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FinYears");
                });

            modelBuilder.Entity("Core.Entities.LookUps.ShiftTracking", b =>
                {
                    b.HasOne("Core.Entities.Sec.SecUser", "FromSecUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.Sec.SecUser", "ToSecUser")
                        .WithMany()
                    ...
                    b.Navigation("FromSecUser");

                    b.Navigation("ToSecUser");
            ...
            modelBuilder.Entity("Core.Entities.Sec.UserSetting", b =>
                {
                    b.HasOne("Core.Entities.Sec.Setting", "Setting")
                        .WithMany()
