...
//ng build --base-href /SecurityPermitsSite/
//Scaffold-DbContext "Data Source=HOITL-22837\SQLEXPRESS;Initial Catalog=SecurityPermits;User ID=ahmed;Password=123456;TrustServerCertificate=true;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models
//Scaffold-DbContext "Data Source=150-237-205-92\SQL2022;Initial Catalog=iExchange_AlnatheerNew;User ID=ahmed;Password=123456;TrustServerCertificate=true;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models


//nswag openapi2tsclient /input:https://localhost:7073/swagger/v1/swagger.json /output:src/app/services/SBapi.service.ts

//"Accept": "text/plain","Authorization": "Bearer " + localStorage.getItem('token')

//ng build --base-href /SecurityPermitsSite/
//21857

//_configuration["PhysicalUlrPath"]
...
//add-migration edditt -context dbcontext
...
/*
 ملاحظات
العمله داخل المورد بيتكون بالكود curr code
في الفواتير عادي curr id
...
//ExInvoiceDetails
//ExWholeInvoiceDetails

//--jv--from accountant
//--ind - invoice
//--whl - wholeinvoice method = 1 - i will use for all wholeinvoice
//--brw - wholeinvoice method <>1 bank -- not used
//currencybvr لا تسمع الا من خلال الفواتير
//الرصيد الاجمالي للفرع =currencybvr
//ارصده لدي الصرافين منفصله داخل internaltrans
//ارصده الصندوق =الرصيد الاجمالي - ارصده الصرافين
//
//
//--