...
{
    public class WFListOfApprovalsRepository : BaseRepository<WFListOfApprovals>, IWFListOfApprovalsRepository
    {


        public WFListOfApprovalsRepository(DBContext context) : base(context)
        {
