...
{
    public class WFRequestTypeRepository : BaseRepository<WFRequestType>, IWFRequestTypeRepository
    {


        public WFRequestTypeRepository(DBContext context) : base(context)
        {
