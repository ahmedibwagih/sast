...
{
    public class WFRequestDetailsRepository : BaseRepository<WFRequestDetails>, IWFRequestDetailsRepository
    {


        public WFRequestDetailsRepository(DBContext context) : base(context)
        {
