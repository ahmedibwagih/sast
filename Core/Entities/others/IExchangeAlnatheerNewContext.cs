...
//public partial class IExchangeAlnatheerNewContext : DbContext
//{
//    public IExchangeAlnatheerNewContext()
//    {
//    }

//    public IExchangeAlnatheerNewContext(DbContextOptions<IExchangeAlnatheerNewContext> options)
//        : base(options)
//    {
//    }
...
//    public virtual DbSet<CurrenciesMain> CurrenciesMains { get; set; }
...
//    public virtual DbSet<IdentitySource> IdentitySources { get; set; }
...
//    public virtual DbSet<PrivilageType> PrivilageTypes { get; set; }
...
//    public virtual DbSet<TransferPurpose> TransferPurposes { get; set; }

//    public virtual DbSet<User> Users { get; set; }

//    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
//        => optionsBuilder.UseSqlServer("Data Source=HOITL-22837\\SQL2022;Initial Catalog=iExchange_AlnatheerNew;User ID=ahmed;Password=123456;TrustServerCertificate=true;", x => x.UseNetTopologySuite());
...
//        modelBuilder.Entity<AAccountClassification>(entity =>
//        {
...
//        modelBuilder.Entity<ACashFlow>(entity =>
//        {
...
//        modelBuilder.Entity<ACashFlowStatus>(entity =>
//        {
...
//        modelBuilder.Entity<ACashFlowType>(entity =>
//        {
...
//        modelBuilder.Entity<AJv>(entity =>
//        {
...
//        modelBuilder.Entity<AJvsDetail>(entity =>
//        {
...
//        modelBuilder.Entity<AJvstatus>(entity =>
//        {
//            entity.HasKey(e => e.StatusId);
...
//        modelBuilder.Entity<AJvtype>(entity =>
//        {
...
//        modelBuilder.Entity<ASettlement>(entity =>
//        {
...
//        modelBuilder.Entity<CurrenciesMain>(entity =>
//        {
...
//        modelBuilder.Entity<DxTransaction>(entity =>
//        {
...
//        modelBuilder.Entity<ExAttachmentType>(entity =>
//        {
...
//        modelBuilder.Entity<ExBank>(entity =>
//        {
...
//        modelBuilder.Entity<ExBranch>(entity =>
//        {
...
//        modelBuilder.Entity<ExBranchTransfer>(entity =>
//        {
//            entity.HasKey(e => e.VoucherId);
...
//        modelBuilder.Entity<ExBranchTransferStatus>(entity =>
//        {
//            entity.HasKey(e => e.StatusId);
...
//        modelBuilder.Entity<ExBranchTransferType>(entity =>
//        {
//            entity.HasKey(e => e.TypeId);
...
//        modelBuilder.Entity<ExBranchTransfersDetail>(entity =>
//        {
...
//        modelBuilder.Entity<ExCashier>(entity =>
//        {
...
//        modelBuilder.Entity<ExClient>(entity =>
//        {
...
//        modelBuilder.Entity<ExClientJob>(entity =>
//        {
...
//        modelBuilder.Entity<ExClientJobSeverity>(entity =>
//        {
...
//        modelBuilder.Entity<ExClientsAttachment>(entity =>
//        {
...
//        modelBuilder.Entity<ExClientsMembership>(entity =>
//        {
...
//        modelBuilder.Entity<ExClientsRepresentative>(entity =>
//        {
...
//        modelBuilder.Entity<ExClientsType>(entity =>
//        {
...
//        modelBuilder.Entity<ExCountry>(entity =>
//        {
...
//        modelBuilder.Entity<ExCurrenciesBvr>(entity =>
//        {
...
//        modelBuilder.Entity<ExCurrenciesMarketPrice>(entity =>
//        {
...
//        modelBuilder.Entity<ExExchangePurpose>(entity =>
//        {
...
//        modelBuilder.Entity<ExFormingStatus>(entity =>
//        {
...
//        modelBuilder.Entity<ExIdsource>(entity =>
//        {
...
//        modelBuilder.Entity<ExIncomeSource>(entity =>
//        {
...
//        modelBuilder.Entity<ExInternalTransfer>(entity =>
//        {
...
//        modelBuilder.Entity<ExInternalTransfersClosingDetail>(entity =>
//        {
...
//        modelBuilder.Entity<ExInternalTransfersDetail>(entity =>
//        {
...
//        modelBuilder.Entity<ExInternalTransfersDetailsTemp>(entity =>
//        {
...
//        modelBuilder.Entity<ExInvoice>(entity =>
//        {
...
//        modelBuilder.Entity<ExInvoiceStatus>(entity =>
//        {
//            entity.HasKey(e => e.StatusId);
...
//        modelBuilder.Entity<ExInvoicesDetail>(entity =>
//        {
...
//        modelBuilder.Entity<ExInvoicesType>(entity =>
//        {
...
//        modelBuilder.Entity<ExLocallyWanted>(entity =>
//        {
...
//        modelBuilder.Entity<ExMonetaryAgency>(entity =>
//        {
...
//        modelBuilder.Entity<ExPaymentMethod>(entity =>
//        {
...
//        modelBuilder.Entity<ExSamaCurrency>(entity =>
//        {
//            entity
//                .HasNoKey()
...
//        modelBuilder.Entity<ExSetting>(entity =>
//        {
...
//        modelBuilder.Entity<ExStatisticalDataVar>(entity =>
//        {
...
//        modelBuilder.Entity<ExSupplier>(entity =>
//        {
...
//        modelBuilder.Entity<ExSuppliersAsBranch>(entity =>
//        {
//            entity
//                .HasNoKey()
...
//        modelBuilder.Entity<ExSuppliersType>(entity =>
//        {
...
//        modelBuilder.Entity<ExSuppliersWithoutBranch>(entity =>
//        {
//            entity
//                .HasNoKey()
...
//        modelBuilder.Entity<ExWholeInvoice>(entity =>
//        {
//            entity.HasKey(e => e.InvoiceId);
...
//        modelBuilder.Entity<ExWholeInvoiceStatus>(entity =>
//        {
//            entity.HasKey(e => e.StatusId);
...
//        modelBuilder.Entity<ExWholeInvoicesDetail>(entity =>
//        {
...
//        modelBuilder.Entity<ExWholePaymentMethod>(entity =>
//        {
//            entity.HasKey(e => e.PaymentMethod);
...
//        modelBuilder.Entity<IdentitySource>(entity =>
//        {
//            entity.HasIndex(e => e.CountryId, "IX_IdentitySources_CountryId");

//            entity.Property(e => e.IsActve).HasDefaultValue(1);

//            entity.HasOne(d => d.Country).WithMany(p => p.IdentitySources).HasForeignKey(d => d.CountryId);
//        });

//        modelBuilder.Entity<IsilList>(entity =>
//        {
...
//        modelBuilder.Entity<IsilXmlDatum>(entity =>
//        {
...
//            entity.HasIndex(e => e.JobId, "IX_Privilage_JobId");

//            entity.HasIndex(e => e.PrivilageTypeId, "IX_Privilage_PrivilageTypeId");

//            entity.HasIndex(e => e.ScreensId, "IX_Privilage_ScreensId");

//            entity.HasOne(d => d.Job).WithMany(p => p.Privilages).HasForeignKey(d => d.JobId);

//            entity.HasOne(d => d.PrivilageType).WithMany(p => p.Privilages).HasForeignKey(d => d.PrivilageTypeId);

//            entity.HasOne(d => d.Screens).WithMany(p => p.Privilages).HasForeignKey(d => d.ScreensId);
//        });

//        modelBuilder.Entity<Privilage2>(entity =>
//        {
//            entity
//                .HasNoKey()
//                .ToTable("Privilage2");
...
//        modelBuilder.Entity<PrivilageType>(entity =>
//        {
//            entity.ToTable("PrivilageType");

//            entity.HasIndex(e => e.ScreensId, "IX_PrivilageType_ScreensId");

//            entity.HasOne(d => d.Screens).WithMany(p => p.PrivilageTypes).HasForeignKey(d => d.ScreensId);
//        });
...
//        modelBuilder.Entity<SecForm>(entity =>
//        {
...
//        modelBuilder.Entity<SecFormsFunction>(entity =>
//        {
...
//        modelBuilder.Entity<SecTransactionLog>(entity =>
//        {
...
//        modelBuilder.Entity<SecUsersForm>(entity =>
//        {
...
//            entity.HasIndex(e => new { e.UserId, e.FormId }, "UQ_Sec_UsersForms").IsUnique();
...
//            entity.HasOne(d => d.User).WithMany(p => p.SecUsersForms)
//                .HasForeignKey(d => d.UserId)
//                .HasConstraintName("FK_Sec_UsersForms_Sec_Users");
//        });

//        modelBuilder.Entity<SecUsersFunction>(entity =>
//        {
...
//            entity.HasIndex(e => new { e.UserId, e.FormFunctionId }, "UQ_Sec_UsersFunctions").IsUnique();
...
//            entity.HasOne(d => d.User).WithMany(p => p.SecUsersFunctions)
//                .HasForeignKey(d => d.UserId)
//                .HasConstraintName("FK_Sec_UsersFunctions_Sec_Users");
//        });

//        modelBuilder.Entity<SysAssembly>(entity =>
//        {
...
//        modelBuilder.Entity<SysBackup>(entity =>
//        {
...
//        modelBuilder.Entity<SysBranchesAuto>(entity =>
//        {
...
//        modelBuilder.Entity<SysMobileIntegration>(entity =>
//        {
...
//        modelBuilder.Entity<SysReplicationSetting>(entity =>
//        {
...
//        modelBuilder.Entity<SysSystemOption>(entity =>
//        {
...
//        modelBuilder.Entity<SysWebsiteIntegration>(entity =>
//        {
...
//        modelBuilder.Entity<TechSupTicket>(entity =>
//        {
...
//        modelBuilder.Entity<TransferPurpose>(entity =>
//        {
//            entity.Property(e => e.IsActve).HasDefaultValue(1);
//        });
